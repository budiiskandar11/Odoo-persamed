<html>
	...
	% for o in objects:
		...
		<p>
			<b>Quotation sAcceptance - <b style="font-size:12px">FAX TO: ${o.company_id.fax or '-'} / EMAIL TO: ${o.company_id.email or '-'}</b></b>
		</p>
		<table class="content padding border_black fright" width="100%">
			<tr>
				<td class="content vtop hright paddingright"><b>Terms and Agreement :</b></td>
		...
		<p class="content">
			If you elect to accept this quotation, please complete the above and return to ${o.company_id.name or '-'} by FAX or email.
		</p>
		<p class="content">
			<u><b>PLEASE NOTE:</b></u>
			<ol type="1" class="content">
				<li>Prices quoted are subject to availability</li>
				<li>Purchases cannot commence until Authorisation has been completed and returned.</li>
				<li>Standard freight charges do not include insurance coverage.</li>
			</ol>
		</p>
	% endfor
	-->
